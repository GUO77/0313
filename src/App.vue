...
<template>
  <div class="site">
    ...
    <header class="top-nav">
      <div class="container grid-row nav-grid" @mouseleave="activeMenu = null">
      ...
      <div v-show="activeMenu" class="mega-menu" @mouseenter="activeMenu = activeMenu || 'product'">
        <div class="container mega-wrap">
          <aside class="mega-side">
            ...
            <div class="mega-side-tabs">
              <button type="button" class="is-active">产品体系</button>
              <button type="button">服务类型</button>
            </div>
          </aside>
          <div class="mega-main">
            <div class="mega-col">
            ...
            <div class="mega-col">
              <h4>企业数智供应链产品</h4>
              <a href="#">企业数智供应链仓库产品</a>
              <a href="#">供应链核心管理系统</a>
              <a href="#">企业供应链数字孪型</a>
              <a href="#">一体化智管 SCM 系统</a>
            </div>
            <div class="mega-col">
              <h4>物流供应链增值服务方案</h4>
              <a href="#">金融科技服务</a>
